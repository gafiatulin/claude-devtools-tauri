...
export interface EnhancedAIChunk extends AIChunk {
  ...
  /** Type-guard discriminant marker. Message data is in `responses` and `sidechainMessages`. */
  enhanced: true;
}
...
export interface EnhancedUserChunk extends UserChunk {
  /** Type-guard discriminant marker. Message data is in `userMessage`. */
  enhanced: true;
}
...
export interface EnhancedSystemChunk extends SystemChunk {
  /** Type-guard discriminant marker. Message data is in `message`. */
  enhanced: true;
}
