      ...
      {isExpanded && (
        <div className="space-y-3 p-3">
          <SubagentMetrics
            ...
            modelInfo={modelInfo}
            isTeamMember={!!subagent.team}
            mainSessionImpact={subagent.mainSessionImpact}
          ...
          <SubagentTrace
            ...
            toggleSubagentTraceExpansion={toggleSubagentTraceExpansion}
            ...
            searchCurrentSubagentItemId={searchCurrentSubagentItemId}
